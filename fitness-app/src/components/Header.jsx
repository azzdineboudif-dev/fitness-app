...
import '../App.css';
import '../parallax.css'; // On ajoute le CSS Parallaxe
...
const Header = () => {
  ...
  return (
    <header className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <button onClick={() => scrollToSection('temoignages')}
                className="text-white hover:text-[var(--fitness-orange)] transition-colors duration-300">
                Témoignages
              </button>
      ...
      <div 
        id="accueil"
        className="relative h-screen bg-cover bg-center bg-no-repeat parallax" 
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-white max-w-4xl mx-auto px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in-up" data-speed="0.2">
              Atteignez Vos 
              <span className="block" style={{ color: 'var(--fitness-orange)' }}>
                Objectifs Fitness
              </span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 animate-fade-in-up animation-delay-300" data-speed="0.3">
